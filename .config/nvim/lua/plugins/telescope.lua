...
return {
	...
	keys = {
		...
		-- <leader>ft belongs to todo-comments (Find TODOs); colorschemes live under UI toggles
		{ "<leader>uc", "<cmd>Telescope colorscheme<cr>", desc = "Color schemes" },
	},
				...
				mappings = {
					i = {
						...
						["<CR>"] = function(prompt_bufnr)
							custom_open(prompt_bufnr, "edit")
						end,
						["<C-v>"] = function(prompt_bufnr)
							custom_open(prompt_bufnr, "vsplit")
						end,
						["<C-x>"] = function(prompt_bufnr)
							custom_open(prompt_bufnr, "split")
						end,
