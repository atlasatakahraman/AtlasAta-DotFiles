...
try {
  ...
  const prompt = [
    ...
    "",
    "Rules:",
    "- ADRs are CENTRAL. Never write into 10-Repos/<repo>/Decisions/ - that path is retired",
    "  and the vault gitignores 10-Repos/*/, so anything there is invisible to vault history.",
